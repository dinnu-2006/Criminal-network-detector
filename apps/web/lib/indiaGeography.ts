// Complete administrative database of all 28 States and 8 Union Territories of India with all districts
...
export const INDIA_STATES_DISTRICTS: Record<string, string[]> = {
  ...
  "Maharashtra": [
    ...
    "Chhatrapati Sambhaji Nagar", "Dharashiv", "Dhule", "Gadchiroli", "Gondia", "Hingoli",
  ...
  "Punjab": [
    ...
    "Moga", "Pathankot", "Patiala", "Rupnagar", "Sahibzada Ajit Singh Nagar (Mohali)", "Sangrur",
...
export function getDistrictsForState(stateName: string): string[] {
  return INDIA_STATES_DISTRICTS[stateName] || [];
}
